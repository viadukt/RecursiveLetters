...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static final int DEFAULT_SIZE = 2048; // -----------------------------------------------------------------------------> original: 512
    private static int width  = DEFAULT_SIZE; 
    private static int height = DEFAULT_SIZE/4; 

    // default pen radius
    private static final double DEFAULT_PEN_RADIUS = 0.0003; // -----------------------------------------------------------------------------> original: 0.002
    ...
    *************************************************************************/
    ...
    public static void line(double x0, double y0, double x1, double y1) {
        offscreen.draw(new Line2D.Double(scaleX(x0/4), scaleY(y0), scaleX(x1/4), scaleY(y1))); // ------------------------------------------------>>>>>>>>>
        draw();
    }
